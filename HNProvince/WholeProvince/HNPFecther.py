...
class SZFFetcher:
    ...
    def loc_policy(self):
        ...
        api_url = "http://www.xinjiang.gov.cn/guestweb/sHtml"
        ...
        for j in range(1, len(key_params)):
            ...
            while True:
                ...
                try:  # 开始爬取政策列表，由于浙江提供了对应的content值是完整的所以不需要跳转对应位置文本过滤
                    ...
                    preview_data = requests.post(url=api_url, params=json.dumps(params), headers=headers)  # 开始爬取政策列表
                    # 测试代码使用
