...
if __name__ == "__main__":
    ...
    api_url = "http://search.zj.gov.cn/jsearchfront/interfaces/search.do"
    preview_data = requests.post(url=api_url, data=params).json()
    data_str = json.dumps(preview_data, indent=4, ensure_ascii=False)
    with open("success5.json", "w", encoding="utf-8") as f:
        f.write(data_str)
